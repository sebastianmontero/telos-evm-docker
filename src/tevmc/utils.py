...
def find_closest_snapshot_url(
    network: Literal['mainnet'] | Literal['testnet'],
    block_number: int
) -> str:
    ...
    if network == 'mainnet':
        ...
        raise NotImplementedError(f'Snapshot finiding for network {network} not implemented')
